...
import com.example.shiwu.Sqlite.DBService;
import com.example.shiwu.Sqlite.Question;
...
public class dati extends AppCompatActivity {
    ...
    private String DB_NAME = "liji.db";
    //数据库的地址
    private String DB_PATH = "/data/data/com.example.shiwu/databases/";
    //总的题目数据
    private int count;
    //当前显示的题目
    private int corrent;
        ...
        btn_down.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (corrent < count - 1) {
                    ...
                    new AlertDialog.Builder(dati.this).setTitle("提示").setMessage("已经到达最后一道题，是否退出？")
                    ...
                    if(wrongList.size() == 0){
                        new AlertDialog.Builder(dati.this).setTitle("提示").setMessage("你好厉害，答对了所有题！")
                                .setPositiveButton("确定", new DialogInterface.OnClickListener() {
                                    @Override
                                    public void onClick(DialogInterface dialog, int which) {
                                        finish();
                    ...
                    //窗口提示
                    new AlertDialog.Builder(dati.this).setTitle("恭喜，答题完成！")
